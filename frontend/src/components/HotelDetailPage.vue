    ...
    <section class="detail-header">
      <div class="image-gallery">
        ...
        <div class="sub-images">
          <img src="https://placehold.co/600x400?text=Hotel+Image+2" :alt="hotel.hName + ' 이미지 2'">
          <img src="https://placehold.co/600x400?text=Hotel+Image+3" :alt="hotel.hName + ' 이미지 3'">
          <img src="https://placehold.co/600x400?text=Hotel+Image+4" :alt="hotel.hName + ' 이미지 4'">
          <img src="https://placehold.co/600x400?text=Hotel+Image+5" :alt="hotel.hName + ' 이미지 5'">
