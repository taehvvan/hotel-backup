...
import heroBg from '@/assets/images/card-Incheon.jpg';
...
.main-showcase.hero-banner{
  ...
  height: 480px;                 /* 420~520px 사이로 조절 가능 */
  border-bottom-left-radius: 28px;
  border-bottom-right-radius: 28px;
  overflow: hidden;

  position: relative;            /* 검색바 절대배치 기준 */
  margin-top: 56px;              /* 헤더에 가리지 않게 양의 값 */
}
...
.more-link{ text-decoration:none; color:#222; font-weight:500; }
