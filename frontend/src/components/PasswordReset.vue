<template>
  ...
  const sendVerificationCode = async () => {
    try {
      const response = await axios.post('http://localhost:8888/api/request-reset-password', {
        email: email.value
      });
  ...
  const verifyCode = async () => {
    try {
      const response = await axios.post('http://localhost:8888/api/verify-code-for-password-reset', {
        email: email.value,
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8888/api/reset-password', {
